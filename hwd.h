...
//函数说明：获取护卫盾模块版本号
//======================================================
HWD_API int __stdcall hwd_getVersion();
...
//======================================================
HWD_API bool __stdcall hwd_getLastErrorMsg(char *buffer, int bufferLen);
...
//======================================================
HWD_API int __stdcall hwd_getLastErrorCode();
...
//======================================================
HWD_API bool __stdcall hwd_loadSkinByByte(char *skin, int skinLen, const char *zipPwd);
...
//======================================================
HWD_API bool __stdcall hwd_loadSkinByFile(const char *filePath, const char *zipPwd);
...
//======================================================
HWD_API bool __stdcall hwd_init(const char *url, int port, const char *webkey, const char *sid, const char *key, bool loading, bool proCom, bool isDebug, int checkDebug);
...
//======================================================
HWD_API bool __stdcall hwd_getSoftInfo(const char *name, char *buffer, int bufferLen);
...
//======================================================
HWD_API bool __stdcall hwd_getSoftVersionInfo(const char *version, const char *name, char *buffer, int bufferLen);
...
//参数<3>：bufferLen，缓冲区尺寸
//======================================================
HWD_API bool __stdcall hwd_getSoftPara(const char *name, char *buffer, int bufferLen);
...
//参数<2>：bufferLen，缓冲区尺寸
//======================================================
HWD_API bool __stdcall hwd_getCaptchaImg(char *buffer, int bufferLen);
...
//参数<2>：bufferLen，缓冲区尺寸
//======================================================
HWD_API bool __stdcall hwd_getCaptchaImgFile(char *buffer, int bufferLen);
...
//参数<2>：bufferLen，缓冲区尺寸
//======================================================
HWD_API bool __stdcall hwd_getMachineCode(char *buffer, int bufferLen);
...
//======================================================
HWD_API bool __stdcall hwd_reg(const char *username, const char *password, const char *email, const char *referrer, const char *code);
...
//======================================================
HWD_API bool __stdcall hwd_sendMail(const char *username, const char *email, const char *code);
...
//======================================================
HWD_API bool __stdcall hwd_resetPwd(const char *username, const char *password, const char *mailcode, const char *code);
...
//======================================================
HWD_API bool __stdcall hwd_recharge(const char *user, const char *cardnum, const char *code);
...
//参数<2>：remark，添加黑名单理由
//======================================================
HWD_API bool __stdcall hwd_addBlackList(const char *code, const char *remark);
...
//======================================================
HWD_API bool __stdcall hwd_login(const char *username, const char *password, const char *code, const char *client_version);
...
//参数<3>：bufferLen，缓冲区尺寸
//======================================================
HWD_API bool __stdcall hwd_getUserInfo(const char *name, char *buffer, int bufferLen);
...
//参数<3>：bufferLen，缓冲区尺寸
//======================================================
HWD_API bool __stdcall hwd_getUserPara(const char *name, char *buffer, int bufferLen);
...
//======================================================
HWD_API bool __stdcall hwd_deductPoint(int point, const char *remarks, int interval);
...
//======================================================
HWD_API bool __stdcall hwd_deductTime(int minute, const char *remarks, int interval);
...
//======================================================
HWD_API bool __stdcall hwd_deductBalance(double money, const char *remarks, int interval);
...
//======================================================
HWD_API bool __stdcall hwd_setUserbind(const char *str);
...
//======================================================
HWD_API bool __stdcall hwd_bindMachineCode(const char *username);
...
//======================================================
HWD_API bool __stdcall hwd_logout();
...
//参数<4>：bufferLen，缓冲区尺寸
//======================================================
HWD_API bool __stdcall hwd_callPHP(const char *name, const char *para, char *buffer, int bufferLen);
...
//参数<4>：bufferLen，缓冲区尺寸
//======================================================
HWD_API bool __stdcall hwd_getPcMsg(const char *key, const char *name, char *buffer, int bufferLen);
...
//======================================================
HWD_API bool __stdcall hwd_heartbeat(int time, const char *loginAuth);
...
//======================================================
HWD_API bool __stdcall hwd_loadLoginWindow(const char *version, const char *title, int noticeTime, const char *menuItem, bool autoHeartbeat);
...
//======================================================
HWD_API bool __stdcall hwd_loadRegWindow();
...
//======================================================
HWD_API bool __stdcall hwd_loadRepwdWindow();
...
//======================================================
HWD_API bool __stdcall hwd_loadRechargeWindow();
...
//参数<2>：value，配置值
//======================================================
HWD_API bool __stdcall hwd_save(const char *name, const char *value);
...
//参数<4>：bufferLen，缓冲区尺寸
//======================================================
HWD_API bool __stdcall hwd_read(const char *name, const char *defaultValue, char *buffer, int bufferLen);
...
//参数<3>：bufferLen，缓冲区尺寸
//======================================================
HWD_API bool __stdcall hwd_htmlFilter(const char *htmlStr, char *buffer, int bufferLen);
...
//======================================================
HWD_API bool __stdcall hwd_fastCheck(const char *url, int port, const char *webkey, const char *sid, const char *key, const char *softPara, bool isDebug, int checkDebug);
...
//参数<4>：bufferLen，缓冲区尺寸
//======================================================
HWD_API bool __stdcall hwd_getFastInfo(const char *name, char *buffer, int bufferLen);
...
//参数<3>：bufferLen，缓冲区尺寸
//======================================================
HWD_API bool __stdcall hwd_getFastPara(const char *name, char *buffer, int bufferLen);
...
//函数说明：蓝色天空,计算机蓝屏.
//======================================================
HWD_API bool __stdcall hwd_blueSky();
...
//参数<3>：bufferLen，缓冲区尺寸
//======================================================
HWD_API bool __stdcall hwd_getFileMD5(const char *filename, char *buffer, int bufferLen);
...
//参数<3>：bufferLen，缓冲区尺寸
//======================================================
HWD_API bool __stdcall hwd_getStrMD5(const char *str, char *buffer, int bufferLen);
...
//参数<2>：bufferLen，缓冲区尺寸
//======================================================
HWD_API bool __stdcall hwd_getRuningPath(char *buffer, int bufferLen);
...
//参数<2>：bufferLen，缓冲区尺寸
//======================================================
HWD_API bool __stdcall hwd_getModulePath(char *buffer, int bufferLen);